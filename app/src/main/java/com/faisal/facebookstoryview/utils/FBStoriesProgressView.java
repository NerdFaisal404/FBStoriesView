package com.faisal.facebookstoryview.utils;
...
import com.faisal.facebookstoryview.R;

import java.util.ArrayList;
import java.util.List;

public class FBStoriesProgressView extends LinearLayout {

    private static final String TAG = FBStoriesProgressView.class.getSimpleName();
    ...
    public FBStoriesProgressView(Context context) {
        this(context, null);
    }

    public FBStoriesProgressView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public FBStoriesProgressView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public FBStoriesProgressView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(Context context, @Nullable AttributeSet attrs) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.FBStoriesProgressView);
        storiesCount = typedArray.getInt(R.styleable.FBStoriesProgressView_progressCount, 0);
        typedArray.recycle();
        bindViews();
    }
